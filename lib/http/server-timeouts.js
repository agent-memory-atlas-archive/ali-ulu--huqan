...
function resolveRequestLimits(readEnvironment) {
  if (typeof readEnvironment !== 'function') throw new TypeError('readEnvironment must be a function');
  return Object.freeze({ maxConcurrent: boundedLimit('MAX_CONCURRENT_REQUESTS', readEnvironment('HUQAN_MAX_CONCURRENT_REQUESTS'), DEFAULT_MAX_CONCURRENT_REQUESTS), retryAfterMs: DEFAULT_RETRY_AFTER_MS });
}
