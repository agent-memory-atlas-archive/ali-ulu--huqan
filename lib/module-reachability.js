...
const NOT_YET_WIRED = Object.freeze({
  ...
  // --- experience ----------------------------------------------------------
  // E1 ships before its consumer on purpose: the contract is pure by product
  // decision and gains a production caller the moment the E2 journal requires
  // it. Graduating this line means landing that require -- deleting it
  // without one fails the check as a stale acknowledgement.
  'lib/experience/contract.js': 'E1 ExperienceContract primitive, pure by product decision; first production consumer is the E2 journal that requires it',
});
