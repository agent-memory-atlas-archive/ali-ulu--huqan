...
/**
 * Audit write through the public graph surface (#2345). Kernel exposes no
 * public audit append (pinned by kernel-facade-contract), and reaching
 * `kernel._appendAuditEvent` from here is the cross-module private call this
 * module is recorded for -- so the call goes to `kernel.graph.appendAuditEvent`
 * with the same null-safe, swallow-and-null contract, and a kernel without a
 * graph simply records nothing.
 */
