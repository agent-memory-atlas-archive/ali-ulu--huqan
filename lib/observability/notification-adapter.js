...
function normalizeId(value, field) {
  ...
  // oxlint-disable-next-line no-control-regex -- deliberate: rejects control characters in a workspace id
...
function normalizeOptionalString(value, field, maximum = 160) {
  ...
  // oxlint-disable-next-line no-control-regex -- deliberate: rejects control characters before the value is used
