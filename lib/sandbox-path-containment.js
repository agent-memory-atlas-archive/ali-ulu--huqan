 ...
 *
 * `fs.realpathSync`, not `.native`: the native form also expands Windows 8.3
 * short names, so an existing root came back long while a planned child kept
 * its short spelling and read as outside. Symlinks and junctions still resolve.
 *
