...
const ACTION_CATEGORIES = Object.freeze({
  ...
  // Financial movement (#2505/D): money leaves the operator's control and is
  // hard to reverse, so it is a first-class category, not a network-call
  // footnote. Keyword inference and the amount/destination/reversibility rule
  // are the follow-up; explicit callers already resolve here.
...
const CATEGORY_ALIASES = Object.freeze({
  ...
  BILLING: 'FINANCIAL_TRANSACTION',
  INVOICE: 'FINANCIAL_TRANSACTION',
  REFUND: 'FINANCIAL_TRANSACTION',
  CHARGE: 'FINANCIAL_TRANSACTION',
  PAYOUT: 'FINANCIAL_TRANSACTION',
...
const RISK_BY_CATEGORY = Object.freeze({
  ...
  FINANCIAL_TRANSACTION: RISK_LEVELS.CRITICAL,
});
