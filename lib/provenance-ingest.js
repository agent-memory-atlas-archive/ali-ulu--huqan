...
// prov_ ids are stable identifiers: the sha1 mint below is byte-identical to
// the pre-split implementation. Changing the algorithm would re-mint every
// stored id, so any migration is a separate, deliberate change -- not part
// of this move-only split (#2246).
